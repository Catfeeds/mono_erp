...
function printSuccess($client, $response) {
    return printReply($client, $response);
}
...
function printReply($client, $response){
	...
	//if($highestSeverity=="SUCCESS"){return $client->__getLastResponse();}
	//if($highestSeverity=="WARNING"){return $client->__getLastResponse();}
	//if($highestSeverity=="ERROR"){}
	//if($highestSeverity=="FAILURE"){}
	//printNotifications($response -> Notifications);
	//$xml=printRequestResponse($client, $response);
	//return $xml;
}
...
function getProperty($var){
	if($var == 'key') Return 'NQgQQIlsJRQhHyyz'; 
	if($var == 'password') Return 'IfhicugADmq8nRVaUbVOsTTpI'; 
	if($var == 'shipaccount') Return '367545593';
	if($var == 'billaccount') Return '367545593'; 
	if($var == 'dutyaccount') Return '367545593'; 
	if($var == 'freightaccount') Return '367545593';  
	if($var == 'trackaccount') Return '367545593'; 
	if($var == 'dutiesaccount') Return '367545593';
	if($var == 'importeraccount') Return '367545593';
	if($var == 'brokeraccount') Return '367545593';
	if($var == 'distributionaccount') Return '367545593';
