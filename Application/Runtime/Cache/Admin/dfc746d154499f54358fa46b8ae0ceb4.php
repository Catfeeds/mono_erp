...
var _ACTION_  = '/erptest/index.php/Admin/Rbac/access';
var _PUBLIC_ = '/erptest/Public';
var _TIMESTAMP_ = <?php echo time();?>;
var _SELF_ = '/erptest/index.php/Admin/Rbac/access/roleid/11.html';
...
<link rel="stylesheet" href="/erptest/Application/Admin/View/Default/js/treetable/css/jquery.treeTable.css">
<script src="/erptest/Application/Admin/View/Default/js/treetable/jquery.treetable.js"></script>
<div class="admin">

<form action="<?php echo U('/Admin/Rbac/accessEdit');?>" method="post" name="form" id="form">
