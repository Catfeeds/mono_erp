...
<script>//定义需要的“常量”
var _CONTROLLER_ = '/test/erptest/index.php/Admin/ServiceManage';
var _ACTION_  = '/test/erptest/index.php/Admin/ServiceManage/index';
var _PUBLIC_ = '/test/erptest/Public';
var _TIMESTAMP_ = <?php echo time();?>;
var _SELF_ = '/test/erptest/index.php/Admin/ServiceManage/index.html';
