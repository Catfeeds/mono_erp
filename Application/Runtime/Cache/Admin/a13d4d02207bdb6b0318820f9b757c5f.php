...
<script>//定义需要的“常量”
var _CONTROLLER_ = '/erptest/index.php/Admin/ServiceManage';
var _ACTION_  = '/erptest/index.php/Admin/ServiceManage/refund_add';
var _PUBLIC_ = '/erptest/Public';
var _TIMESTAMP_ = <?php echo time();?>;
var _SELF_ = '/erptest/index.php/Admin/ServiceManage/refund_add/id/160/data/2.html';
...
<script src="/erptest/Application/Admin/View/Default/js/serviceManage/refund_add.js"></script>
<div class="admin">
    <form action="<?php echo U('/Admin/ServiceManage/refund_add');?>" method="post" name="form" id="myform">
    <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
    <input type="hidden" name="data" value="<?php echo ($data); ?>">
<table width="98%" border="0" cellpadding="4" cellspacing="1" class="table">

				<tr class="table_title">
					<td colspan="4"  class="fw"><?php echo ($tpltitle); ?> 退款申请</td>
				</tr>
				<tr class="tr rt">
					<td width="100">产品单号：</td>
					<td colspan="3" class="lt">
						<?php if($info["order_number"] ): echo ($info["order_number"]); ?>
                        <?php else: ?>
                            <input type="text" id='order_number' name="order_number" style=" width:300px;"/><?php endif; ?>
					</td>
				</tr>
                <tr class="tr rt">
				...
				<tr class="tr rt">
					<td width="100">备　　注：</td>
					<td colspan="3" class="lt">
						<textarea name="message" style="height:100px; width:400px;"></textarea>
					</td>
				</tr>
	<tr class="tr lt">
		<td colspan="4">
