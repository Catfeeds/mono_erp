...
class PiplApi_SearchRequestConfiguration
{
    ...
    function __construct($api_key = "rwcodo9ntmlv380v0q5bolhp", $minimum_probability = NULL, $minimum_match = 0.01, $show_sources = true,
                         $live_feeds = false, $hide_sponsored = NULL, $use_https = false){
...
class PiplApi_SearchAPIRequest
{
    ...
    public function send($strict_validation=true)
    {
        ...
        $resp = curl_exec($curl);return $resp;//flag
