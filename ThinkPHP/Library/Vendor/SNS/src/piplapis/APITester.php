...
class APITester extends PHPUnit_Framework_TestCase {
    ...
    public function setUp(){
        PiplApi_SearchAPIRequest::get_default_configuration()->api_key = getenv("TEST_KEY");//TEST_KEY
        PiplApi_SearchAPIRequest::$base_url = getenv("API_TESTS_BASE_URL") . "?developer_class=premium";//API_TESTS_BASE_URL
    }
